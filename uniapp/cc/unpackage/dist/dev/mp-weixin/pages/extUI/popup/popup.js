...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    y: common_vendor.sr("popup", "20d971b0-6"),
    ...
    C: common_vendor.sr("message", "20d971b0-7"),
    D: common_vendor.p({
      type: "message"
    }),
    ...
    H: common_vendor.sr("alertDialog", "20d971b0-9"),
    I: common_vendor.p({
      type: "dialog"
    }),
    J: common_vendor.sr("inputClose", "20d971b0-12,20d971b0-11"),
    ...
    M: common_vendor.sr("inputDialog", "20d971b0-11"),
    N: common_vendor.p({
      type: "dialog"
    }),
    O: common_vendor.sr("share", "20d971b0-13"),
    P: common_vendor.p({
      type: "share",
      safeArea: true,
      backgroundColor: "#fff"

  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "261ca474-7-" + i0 + "," + ("261ca474-6-" + i0),
        c: common_vendor.t(item.name),
        d: "261ca474-8-" + i0 + "," + ("261ca474-6-" + i0),
        e: common_vendor.t(item.address),
        f: "261ca474-9-" + i0 + "," + ("261ca474-6-" + i0),
        g: "261ca474-10-" + i0 + "," + ("261ca474-6-" + i0),
        h: index,
        i: "261ca474-6-" + i0 + ",261ca474-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "261ca474-0"),

...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    g: common_vendor.f($data.listData, (item, k0, i0) => {
      return {
        a: "5fa5ca10-10-" + i0 + "," + ("5fa5ca10-9-" + i0),
        b: item.id,
        c: "5fa5ca10-9-" + i0 + ",5fa5ca10-8",
        d: common_vendor.p({
          title: item.author_name,
          avatar: item.cover,
          note: item.title,
